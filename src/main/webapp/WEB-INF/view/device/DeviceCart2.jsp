...
<html>
<head>
<script type="text/javascript" src="resource/js/device/deviceCart2.js"></script>
...
<form class="registerForm" id="createCart" action="createCart2" method="post">
