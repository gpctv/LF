...
import com.lifung.bo.DeviceCartBO2;
import com.lifung.dao.DeviceProfile;
import com.opensymphony.xwork2.ActionSupport;

public class DeviceCartAction2 extends ActionSupport{
    ...
    private DeviceCartBO2 deviceCartBO2;
	...
	public DeviceCartBO2 getDeviceCartBO2() {
		return deviceCartBO2;
	}

	public void setDeviceCartBO2(DeviceCartBO2 deviceCartBO) {
		this.deviceCartBO2 = deviceCartBO;
	}
	...
	public String queryDevice() {
		try {
		this.deviceProfile=	this.deviceCartBO2.queryDeviceProfile(this.storerkey);
	...
	public String queryDeviceId(){
		...
		this.deviceId=this.deviceCartBO2.getStorer();
		return "success";
	}
	public String queryDeviceProfileKey() {
		this.valid="";
		try {
		this.valid=this.deviceCartBO2.queryDeviceProfileKey(this.deviceProfileKey);
		}catch(Exception e) {
			LOG.error("error #0", e);
		}
		return "success";
	...
	public String isExistDeviceId() {
		try {
			this.valid="";
		this.valid=this.deviceCartBO2.queryDeviceId(this.deviceID);
		}catch(Exception e) {
			LOG.error("error #0", e);
		}
		return "success";
	...
	public String createDeviceProfile() {
		try {
			this.deviceCartBO2.create(this.deviceProfileKey, this.ipAddress, this.port, this.deviceID, this.devicePosition);
