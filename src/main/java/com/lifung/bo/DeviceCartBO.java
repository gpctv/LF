...
public class DeviceCartBO {
	...
	public List<DeviceProfile> queryDeviceProfile(String storerKey) {
		Query query =this.sessionFactory.getCurrentSession().getNamedQuery("com.lifung.dao.DeviceProfile.deviceQuery");
	...
	public List<String> getStorer(){
		Query query =this.sessionFactory.getCurrentSession().getNamedQuery("com.lifung.dao.DeviceProfile.Storer");
	...
	public String queryDeviceProfileKey(String deviceProfileKey) throws Exception {
		Query query =this.sessionFactory.getCurrentSession().getNamedQuery("com.lifung.dao.DeviceProfile.queryDeviceProfileKey");
	...
	public String queryDeviceId(String deviceId) throws Exception{
		Query query =this.sessionFactory.getCurrentSession().getNamedQuery("com.lifung.dao.DeviceProfile.deviceId");
	...
	public void create(String deviceProfileKey,String ipAddress,String portNo,String deviceId,int position) {
	   ...
	   for(int i=0;i<position;i++) {
		   ...
		   deviceProfile.setDeviceType("CART");
